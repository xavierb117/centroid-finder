...
export const thumbnail = (req, res) => {
    const getVideo = path.join(process.cwd(), process.env.VIDEOS, req.params.filename);
    const getOutput = path.join(process.cwd(), process.env.OUTPUT_PATH, `${req.params.filename}.jpg`)
