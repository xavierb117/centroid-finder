...
public class GroupFinder {
   /**
    * Finds connected pixel groups of 1s in a binary image.
    * 
    ...
    * (size first, then y, then x). That is, the largest group will be first, the 
    ...
    */
   public static List<Group> findCentroids(int[][] image) {
      return null;
   }
}